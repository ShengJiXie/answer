<template>
	<view class="user_login">
		...
		<view class="user_login_footer">
			<view>注册即表示您已阅读并同意
				<view class="user_login_footer_span" @click="to('userAgreement')">《服务协议》</view>和
				<view class="user_login_footer_span" @click="to('userYinsi')">《隐私政策》</view>
				。
			</view>
		</view>
	</view>
