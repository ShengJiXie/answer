...
var _request = _interopRequireDefault(__webpack_require__(/*! common/request.js */ 13));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}_vue.default.use(_vuex.default); // 引入封装的request请求
var store = new _vuex.default.Store({
  ...
  mutations: {
    GlobalUrl: function GlobalUrl(v, e) {
      console.log(v, e);
      uni.navigateTo({
        url: e });
    ...
    InfoStep: function InfoStep(v) {
      // 修改权限
      var data = uni.getStorageSync('PersonInfo').data;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function _slicedToArray(arr, i) {return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest();}function _nonIterableRest() {throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(o);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}function _iterableToArrayLimit(arr, i) {if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return;var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"] != null) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}function _arrayWithHoles(arr) {if (Array.isArray(arr)) return arr;}var baseUrl = 'https://ask.gzysk.net/';
var request = function request() {var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var StorName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';var date = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};var type = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'GET';var header = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {};
    ...
    return new Promise(function (resolve, reject) {
      if (StorName == 'img') {
        ...
        then(function (response) {
          if (response[1].data.code === 0) {var _response = _slicedToArray(
...
var _request = _interopRequireDefault(__webpack_require__(/*! common/request.js */ 13));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}_vue.default.use(_vuex.default); // 引入封装的request请求
var ApiPost = function ApiPost(obj) {
  ...
  return new Promise(function (resolve, reject) {
    try {
      ...
      if (obj.type === 10) {
        // 首页banner
        (0, _request.default)('api/getBannerInfoByType', 'HomeBanner', {
          type: 0 },
        'GET').then(function (respone) {
          uni.setStorageSync('HomeBanner', respone);
        });
        // 首页新闻公告
        (0, _request.default)('api/getAdvertising', 'HomeNotice').then(function (respone) {
          uni.setStorageSync('HomeNotice', respone);
        });
        // 首页资讯分类
        (0, _request.default)('api/getNewsType', 'HomeType').then(function (respone) {
        ...
        // 首页资讯分类文章列表
        (0, _request.default)('api/getNewsByType', 'HomeText', obj.date, 'GET').then(function (respone) {
          var arr = respone;
          arr.code = 1;
        ...
        // 文章资讯详情页
        (0, _request.default)('api/getNewsById', 'HomeContent', obj.date, 'GET').then(function (respone) {
          var arr = respone;
          arr.code = 1;
        ...
        // 文章收藏功能
        (0, _request.default)('api/collectNews', 'textStar', obj.date, 'GET').then(function (respone) {
          resolve(respone);
        });
      } else if (obj.type === 14) {
        // 修改个人信息
        (0, _request.default)('api/updateUserInfo', 'PersonInfo_handle', obj.date, 'POST').then(function (respone) {
          resolve(respone);
        });

      } else if (obj.type === 201) {
        // 获取个人信息
        (0, _request.default)('api/getUserInfo', 'getUserInfo', obj.date, 'GET').then(function (respone) {
          var arr = respone;
          arr.code = 1;
        ...
        // 微信登录
        (0, _request.default)('api/weChatAuthLogin', 'PersonInfo', obj.date, 'POST').then(function (respone) {
        ...
        // 图片上传
        (0, _request.default)('api/uploadImage', 'img', obj.date, 'POST').then(function (respone) {

          resolve(respone);
        });
      } else if (obj.type === 20) {
        // 获取预约信息
        (0, _request.default)('api/getSubscribeList', 'SubscrList', obj.date).then(function (respone) {
        ...
        // 新增预约表单提交
        (0, _request.default)('api/addSubscribe', 'SubscrForm', obj.date, 'POST').then(function (respone) {
          resolve(respone);
        });
      } else if (obj.type === 22) {
        if (obj.date.question_status === 0) {
          // 获取未回答问题
          (0, _request.default)('api/getMyQuestion', 'PersonHelp0', obj.date, 'GET').then(function (respone) {
            var arr = respone;
            arr.code = 1;
          ...
          // 获取未回答问题
          (0, _request.default)('api/getMyQuestion', 'PersonHelp1', obj.date, 'GET').then(function (respone) {
            var arr = respone;
            arr.code = 1;
        ...
        // 专家管理员登录
        (0, _request.default)('api/accountLogin', 'accountLogin', obj.date, 'POST').then(function (respone) {
          resolve(respone);
        });
      } else if (obj.type === 23) {
        // 获取我的档案
        (0, _request.default)('api/getRecordInfoById', 'PersonArchives', obj.date, 'GET').then(function (respone) {
          var arr = respone;
          arr.code = 1;
        ...
        // 获取提问价格
        (0, _request.default)('api/getQuePrice', 'getQuePrice', obj.date, 'GET').then(function (respone) {
          resolve(respone);
        });
        ...
        // 获取提问分类列表
        (0, _request.default)('api/getQuestionTypes', 'getQuestionTypes', obj.date, 'GET').then(function (respone) {
          uni.setStorageSync('getQuestionTypes', respone);
          resolve(respone);
        });
      } else if (obj.type === 205) {
        // 支付提问
        (0, _request.default)('api/addQuestion', 'addQuestion', obj.date, 'POST').then(function (respone) {
          resolve(respone);
        });
      } else if (obj.type === 206) {
        // 问题详情
        (0, _request.default)('api/getQuestionInfo', 'getQuestionInfo', obj.date, 'GET').then(function (respone) {
          resolve(respone);
        });
        ...
        // 判断手机号是否已绑定
        (0, _request.default)('api/checkUserTel', 'checkUserTel', obj.date).then(function (respone) {
          resolve(respone);
        });
      } else if (obj.type === 100) {
        // 绑定手机号
        (0, _request.default)('api/updateTel', 'updateTel', obj.date, 'POST').then(function (respone) {
          resolve(respone);
        });
